...
function RestaurantMenuContent() {
    ...
    return (
        <div style={{ display: "flex", background: "#fffaf0", minHeight: "100vh", color: "#3d3522", position: "relative" }}>
            <BackgroundPattern />
            <Sidebar />

            <div style={{ flex: 1, padding: "40px", marginLeft: "256px", marginRight: showCart ? "320px" : "24px", zIndex: 10 }}>
                <Link href="/healthymenu">
                    <button
                        style={{
                            marginBottom: "20px",
                            padding: "8px 14px",
                ...
                {!isLoading && filteredMenus.length === 0 && (
                    <p style={{ color: "#5f6b55" }}>No menu available for this restaurant.</p>
                )}
...
export default function RestaurantMenuPage() {
    return (
        <Suspense fallback={<div className="p-10 ml-64">Loading menu...</div>}>
