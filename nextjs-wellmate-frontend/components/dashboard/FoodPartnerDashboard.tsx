                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="rounded-2xl border border-[#eadfce] bg-white px-4 py-3">
                                    ...
                                    <button
                                        ...
                                        className={`mt-2 flex items-center gap-3 rounded-full px-5 py-2 text-xs font-black shadow-sm transition ${storeOnline
                                            ? "bg-[#2f7d57] text-white"
                                            : "bg-[#e6e0d6] text-[#6b5d4b]"
                                            }`}
                                    >
                                        <span
                                            className={`h-3 w-3 rounded-full ${storeOnline ? "bg-white" : "bg-[#cbb89f]"
                                                }`}
                                        />
                    ...
                    {summaryCards.map((card, index) => (
                        ...
                        >
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span
                                    className={`rounded-full px-3 py-1 text-[11px] font-bold ${card.badgeTone === "up"
